...
import { Calendar, Menu, X, ShoppingBag, Phone } from "lucide-react"
...
export default function Navigation() {
  ...
  // Direct cart usage - no more useSafeCart nonsense
  const { state } = useCart()
  ...
  const navItems = [
    ...
    { name: "Despre", href: "/despre", id: "despre" },
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link href="/contact">
                <Button
                  variant="outline"
                  size="sm"
                  className="border-gray-600 text-gray-600 hover:bg-gray-600 hover:text-white transition-all duration-300 bg-transparent"
                >
            ...
            <div className="md:hidden py-4 border-t border-red-100">
              <div className="flex flex-col space-y-4">
                ...
                <Link href="/contact">
                  <Button
                    variant="outline"
                    className="mx-4 border-gray-600 text-gray-600 hover:bg-gray-600 hover:text-white bg-transparent"
                  >
                    <Phone className="w-4 h-4 mr-2" />
                    Contact
                  </Button>
