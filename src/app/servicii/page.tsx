...
export default function ServiciiPage() {
  ...
  const categories = ["Toate", "Consultații", "Injectabile", "Rejuvenare"]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="w-full lg:w-96">
              <SearchInput
                placeholder="🔍 Caută tratamente... (ex: botox, riduri, consultație)"
                value={searchQuery}
          ...
          <div className="mt-4 text-center lg:text-left">
            <p className="text-sm text-gray-600">
              {filteredServices.length === services.length
                ...
                : `${filteredServices.length} din ${services.length} servicii găsite`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {filteredServices.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Nu am găsit servicii</h3>
